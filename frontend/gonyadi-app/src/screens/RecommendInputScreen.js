...
const RecommendInputScreen = () => {
  ...
  const CITIES = ['서울', '부산', '대구', '인천', '광주', '대전', '울산', '세종', '제주', '경주', '전주', '여수', '강릉', '속초', '춘천', '수원', '포항', '통영', '거제', '안동', '목포', '순천', '군산', '경기', '강원', '충북', '충남', '전북', '전남', '경북', '경남', '평창', '가평', '남해', '보령', '태안', '담양', '하동', '경산', '하양', '칠곡', '영천', '청도', '고령', '성주', '의성', '청송', '영양', '영덕', '울진', '울릉', '봉화'];
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const REGION_COORDS = {
        ...
        '경산': { lat: 35.8253, lng: 128.7411 }, '하양': { lat: 35.9067, lng: 128.8233 },
        '칠곡': { lat: 35.9957, lng: 128.4016 }, '영천': { lat: 35.9736, lng: 128.9385 },
        '청도': { lat: 35.6475, lng: 128.7349 }, '고령': { lat: 35.7268, lng: 128.2632 },
        '성주': { lat: 35.9196, lng: 128.2826 }, '의성': { lat: 36.3526, lng: 128.6970 },
        '청송': { lat: 36.4359, lng: 129.0572 }, '영양': { lat: 36.6672, lng: 129.1125 },
        '영덕': { lat: 36.4153, lng: 129.3653 }, '울진': { lat: 36.9927, lng: 129.4003 },
        '울릉': { lat: 37.4845, lng: 130.9057 }, '봉화': { lat: 36.8934, lng: 128.7327 },
      };
