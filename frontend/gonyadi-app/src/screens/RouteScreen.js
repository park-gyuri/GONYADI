...
const styles = StyleSheet.create({
  ...
  tabButton: { height: 32, justifyContent: 'center', paddingHorizontal: 16, borderRadius: 8, borderWidth: 1, borderColor: '#C4CCD8', marginRight: 8, marginBottom: 8 },
  activeTabButton: { backgroundColor: '#E0F2F1', borderColor: '#1ABC9C' },
  tabText: { fontSize: 14, color: '#555' },
  activeTabText: { color: '#111', fontWeight: 'bold' },
  plusButton: { width: 40, height: 32, borderRadius: 8, borderWidth: 1, borderColor: '#C4CCD8', alignItems: 'center', justifyContent: 'center', marginBottom: 8 },
